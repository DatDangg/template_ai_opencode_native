...
Theo `.agent/FEATURE_WORKFLOW.md` §2.3 + §3.6. Không chép lại ở đây.
...
3. Tạo/cập nhật task nếu không phải fix 1 dòng (`tasks/bug-<slug>/...`). Nếu là fix 1 dòng không tạo task:
   ...
   và reviewer vẫn phải ghi report `.context/review-reports/bug-<slug>-one-line-review.md` (chứa Repro Verification)
   để qua close-out gate.
