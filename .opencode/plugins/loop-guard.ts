...
/**
 * loop-guard — Session handoff support (xem `.agent/FEATURE_WORKFLOW.md` § Session handoff & resume).
 *
 * Cung cấp:
      ...
      try {
        output.context.push(
          [
            ...
            "Xem `.agent/FEATURE_WORKFLOW.md` § Session handoff & resume (write-ahead checkpoint, resume matrix, redo policy).",
          ].join("\n"),
        );
      } catch {
        // defensive
